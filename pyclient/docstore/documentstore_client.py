'''
This DocumentStoreClient class interfaces with sawtooth through the REST API
'''
...
class DocumentStoreClient(object):
    '''Client Document store class
    This supports store and retrieve.
    '''
